...
## 项目概述
**Next** 是一个专注的任务管理桌面应用 (Windows)。核心理念：帮你穿透噪音，聚焦于当下最该做的那件事 —— **the next right thing**。通过优先级泳道 + 时间维度组织任务，让"下一步该做什么"一目了然。
...
### 任务管理
- **优先级泳道**: 优先处理 / 就等你翻牌子了 / 待分类 / 短平快 — 帮你决定"下一步做什么"
- **时间维度**: Today / This Week / Next 30 Days — 在对的时间粒度上规划
- **拖拽**: 鼠标拖拽 + 触屏长按拖拽，可跨泳道和时间标签
